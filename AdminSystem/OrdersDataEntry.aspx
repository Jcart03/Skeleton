...
<body style="height: 360px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblOrderTime" runat="server" style="z-index: 1; left: 10px; top: 300px; position: absolute" Text="OrderTime"></asp:Label>
        <asp:Label ID="lblOrderShipped" runat="server" style="z-index: 1; left: 10px; top: 350px; position: absolute" Text="OrderShipped"></asp:Label>
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 10px; top: 400px; position: absolute" Text=""></asp:Label>
        ...
        <asp:TextBox ID="txtOrderTime" runat="server" style="z-index: 1; left: 150px; top: 300px; position: absolute; width: 200px;"></asp:TextBox>
        <asp:CheckBox ID="chkOrderShipped" runat="server" style="z-index: 1; left: 150px; top: 350px; position: absolute" Text="Shipped" />
        <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 15px; top: 450px; position: absolute" Text="OK" OnClick="btnOK_Click" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 75px; top: 450px; position: absolute" Text="Cancel" />
    </form>
</body>
</html>
